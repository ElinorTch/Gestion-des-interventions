...
public class SousCategorieController {
    ...
    public List<SousCategorie> getAllSousCategorie(@PathVariable("idCategorie") Long idCategorie) {
        return sousCategorieService.getAllSousCategorieByIdCategorie(idCategorie);
    }
}
